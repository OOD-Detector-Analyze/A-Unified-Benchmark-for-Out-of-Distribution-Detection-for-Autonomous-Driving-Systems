...
THRESHOLD_ROOT = "/raid/007--Experiments/selforacle/A-Unified-Benchmark-for-Out-of-Distribution-Detection-for-Autonomous-Driving-Systems/Detectors/KDE/thresholds"
THRESHOLD_RANGE  = COMMON_THRESHOLD  # threshold to be used for evaluationG